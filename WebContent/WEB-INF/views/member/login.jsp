...
<br>
	...
	<div class="text-center">
		...
		<button type="button" id="btnFindUserid" onclick="location.href='<%=request.getContextPath() %>/member/idFind'">아이디 찾기</button> | 
		<button type="button" id="btnFindUserpw" onclick="location.href='<%=request.getContextPath() %>/member/pwFind'">비밀번호 찾기</button>	
	</div>
