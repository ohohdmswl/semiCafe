...
<ul class="pagination">
	...
	<%	} else { %>
		<li><a href="./taglist?curPage=<%=paging.getStartPage() - paging.getPageCount() %>">&laquo;</a></li>
	<%	} %>
	...
	<%	if( paging.getCurPage() > 1 ) { %>
	<li>
		<a href="<%=request.getContextPath() %>/tag/taglist?curPage=<%=paging.getCurPage()-1 %>">
			&lt;
		</a>
	</li>
	<%	} %>
	...
	<%	} else { %>
		<li><a href="./taglist?curPage=<%=paging.getStartPage() + paging.getPageCount() %>">&raquo;</a></li>
	<%	} %>
